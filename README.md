...
The goal is to run lightweight LTX video generation workflows from a Rust CLI on Google Colab, while Rust owns validation, job planning, metadata, output contracts, and memory policy.
